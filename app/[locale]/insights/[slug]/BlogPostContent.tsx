...
export default function BlogPostContent() {
    ...
    const blogPostSchema = {
        ...
        "author": { "@type": "Person", "name": post.author, "jobTitle": post.authorRole, "url": "https://www.lopes2tech.ch/about" },
        "publisher": { "@type": "Organization", "name": "Lopes2Tech", "logo": { "@type": "ImageObject", "url": "https://www.lopes2tech.ch/logo_w.svg" } },
        "mainEntityOfPage": { "@type": "WebPage", "@id": `https://www.lopes2tech.ch/${locale}/insights/${post.slug}` }
    };

    const breadcrumbSchema = {
        "@context": "https://schema.org",
        "@type": "BreadcrumbList",
        "@id": `https://www.lopes2tech.ch/${locale}/insights/${post.slug}#breadcrumb`,
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": post.title, "item": `https://www.lopes2tech.ch/${locale}/insights/${post.slug}` }
        ]
    };
            ...
            <article className="relative pt-32 pb-20">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6">
                    ...
                    <div className="print-hide flex items-center gap-3 mb-8">
                        ...
                        <a
                            href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://www.lopes2tech.ch/${locale}/insights/${post.slug}`)}`}
                            target="_blank"
                        ...
                        <a
                            href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://www.lopes2tech.ch/${locale}/insights/${post.slug}`)}&text=${encodeURIComponent(post.title)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center w-9 h-9 rounded-lg bg-white/5 border border-white/10 text-white/60 hover:text-white hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all"
                            aria-label={t('shareX')}
                        ...
                        <a
                            href={`https://wa.me/?text=${encodeURIComponent(post.title + ' - https://www.lopes2tech.ch/' + locale + '/insights/' + post.slug)}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center w-9 h-9 rounded-lg bg-white/5 border border-white/10 text-white/60 hover:text-white hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all"
                        ...
                        <button
                            onClick={async () => {
                                const url = `https://www.lopes2tech.ch/${locale}/insights/${post.slug}`;
                                try {
