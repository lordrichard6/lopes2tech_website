  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        price: "€69",
        reward: "€7",
        pitch: "A venda mais fácil — €69 por um relatório de 1 página com 5 melhorias específicas. Perfeito para entrar pela porta com clientes hesitantes em comprometer.",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        price: "A partir de €69",
        reward: "A partir de €7",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        reward: "€67/mês",
        note: "× 6 meses = €402",
        pitch: "Ambos os canais geridos em conjunto — Meta para awareness + retargeting, Google para pesquisa por intenção. Estratégia unificada e relatórios. Poupa €79/mês vs. comprar separado.",
        bullets: ["Tudo nos planos Meta + Google Ads", "Estratégia cross-channel", "Relatório mensal unificado", "Poupar €79/mês vs. separado"],
        link: "/services/social-media-marketing",
      },
      {
...
const perks = [
  ...
  "Pago por transferência bancária (IBAN)",
