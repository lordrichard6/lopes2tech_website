  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        reward: "CHF 55",
        note: "Paid on delivery",
        pitch: "Everything a business needs to look professional everywhere. Logo, colors, fonts, and a social media kit — all in one package.",
        bullets: ["Logo (3 variations)", "Color palette + typography", "Brand guidelines document", "Social media kit (profile + cover images)"],
      },
    ],
  },
  {
