...
import { Check, Star, ArrowRight, Bot, BookOpen, PhoneCall } from "lucide-react";
...
const packages = [
    {
        ...
        period: null,
        prefix: null,
        description: "Deploy a custom AI chatbot trained on your business knowledge",
        popular: false,
        features: [
            "Custom AI chatbot",
    ...
    },
    {
        ...
        period: null,
        prefix: null,
        description: "AI-powered workflows that automate email, documents, and customer interactions",
        popular: true,
        features: [
    ...
    },
    {
        ...
        period: null,
        prefix: "From",
        description: "Enterprise-grade AI with multi-agent orchestration and custom fine-tuning",
        popular: false,
        features: [
...
export default function AIIntegrationPage() {
    ...
    const serviceSchema = {
        ...
        "@type": "Service",
        "name": "AI Integration & Chatbot Services",
        "description": "AI-powered solutions for Swiss businesses. Custom chatbots, RAG knowledge bases, GPT/Claude API integrations, and multi-agent orchestration.",
        "provider": {
            "@type": "LocalBusiness",
            "name": "Lopes2Tech",
            "address": {
                ...
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-8">
                            Deploy AI agents that understand your business. RAG knowledge bases,
                            custom chatbots, and GPT/Claude API integrations.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                                <BookOpen className="w-5 h-5 text-purple-400" />
                                <span className="text-white">RAG/Knowledge Base</span>
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                                <Bot className="w-5 h-5 text-cyan-400" />
                                <span className="text-white">Function Calling</span>
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                    ...
                    >
                        ...
                        <p className="text-slate-400 mb-6">
                            Book a free consultation to explore how AI can transform your business operations.
                        </p>
                        <button
                            onClick={() => handleRequest("AI Integration")}
