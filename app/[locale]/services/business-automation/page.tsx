...
const packages = [
    {
        ...
        period: null,
        prefix: null,
        description: "Get your first workflow automated and start saving time immediately",
        popular: false,
        features: [
            "1 workflow automation",
            "Tool integration (up to 3)",
            "Setup & documentation",
            "30-day support",
            "Training session"
        ]
    },
    {
        ...
        period: null,
        prefix: null,
        description: "Automate multiple workflows and connect your entire tool stack",
        popular: true,
        features: [
    ...
    },
    {
        ...
        period: null,
        prefix: "From",
        description: "Unlimited custom automation with AI-powered decision logic",
        popular: false,
        features: [
            "Unlimited workflows",
        ...
        <main className="min-h-screen bg-[#0f172a] relative">
            ...
            <section className="relative z-10 pt-32 pb-20">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        <div className="inline-block px-4 py-2 mb-6 text-sm font-semibold text-orange-400 bg-orange-400/10 border border-orange-400/20 rounded-full backdrop-blur-sm">
                        ...
                        <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-8">
                            Eliminate repetitive tasks. Connect your tools. Scale operations without
                            scaling headcount. Custom workflows powered by AI.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                                <Link className="w-5 h-5 text-orange-400" />
                                <span className="text-white">Zapier/Make</span>
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                                <Settings className="w-5 h-5 text-cyan-400" />
                                <span className="text-white">Custom Scripts</span>
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                    ...
                    >
                        ...
                        <p className="text-slate-400 mb-6">
                            Book a free consultation to identify which processes can be automated for maximum impact.
                        </p>
                        <button
