...
const packages = [
    {
        ...
        period: null,
        prefix: null,
        description: "Get your online store up and running with everything you need to start selling",
        popular: false,
        features: [
            "Up to 50 products",
    ...
    },
    {
        ...
        period: null,
        prefix: null,
        description: "Full-featured store with Swiss payments, advanced SEO, and marketing tools",
        popular: true,
        features: [
            "Unlimited products",
            "Custom design",
    ...
    },
    {
        ...
        period: null,
        prefix: "From",
        description: "Enterprise e-commerce with custom checkout, ERP integration, and B2B features",
        popular: false,
        features: [
...
export default function EcommercePage() {
    ...
    const serviceSchema = {
        ...
        "description": "E-commerce solutions for Swiss businesses. Shopify, WooCommerce, or fully custom online stores with Swiss payment integration and multi-currency support.",
        "provider": {
            "@type": "LocalBusiness",
            "name": "Lopes2Tech",
            "address": {
        ...
        <main className="min-h-screen bg-[#0f172a] relative">
            ...
            <section className="relative z-10 pt-32 pb-20">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        <div className="inline-block px-4 py-2 mb-6 text-sm font-semibold text-pink-400 bg-pink-400/10 border border-pink-400/20 rounded-full backdrop-blur-sm">
                        ...
                        <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-8">
                            Launch your online store. Shopify, WooCommerce, or fully custom solutions
                            with Swiss payment integration and multi-currency support.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                                <CreditCard className="w-5 h-5 text-pink-400" />
                                <span className="text-white">Swiss Payments</span>
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-xl border border-white/10">
                    ...
                    >
                        ...
                        <p className="text-slate-400 mb-6">
                            Book a free consultation to plan your online store and start selling.
                        </p>
                        <button
                            onClick={() => handleRequest("E-Commerce")}
