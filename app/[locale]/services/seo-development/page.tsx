...
import { seoDevelopmentPackages } from "@/data/packages-data";
import ServiceFAQ from "@/components/ServiceFAQ";
import ServiceBreadcrumb from "@/components/ServiceBreadcrumb";
import RelatedServices from "@/components/RelatedServices";

const packageConfig = seoDevelopmentPackages;
...
export default function SEODevelopmentPage() {
    ...
    const packages = packageConfig.map((cfg) => ({
        ...
        features: [
            ...
            ...(cfg.key === "growth" ? [t(`packages.${cfg.key}.f6`)] : []),
        ],
    }));
    ...
    return (
        <main className="min-h-screen bg-[#0f172a] relative">
            ...
            <ServiceBreadcrumb serviceName={t("badge")} serviceSlug="seo-development" />
                                ...
                                >
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <p className="text-sm text-slate-500 mt-1">
                                            {pkg.period ? tCommon("billedMonthly") : tCommon("oneTimePayment")}
                                        </p>
                                    </div>
            ...
            <RelatedServices currentSlug="seo-development" />
