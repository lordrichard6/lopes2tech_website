...
import { webAppsPackages } from "@/data/packages-data";
...
const packageConfig = webAppsPackages;
...
export default function WebAppsPage() {
    ...
    return (
        <main className="min-h-screen bg-[#080d1a] relative">
            ...
            <ServiceBreadcrumb serviceName={t("badge")} serviceSlug="web-apps" />
            <Navbar />
            ...
            <RelatedServices currentSlug="web-apps" />
            <Footer />
